...
app.config(['$routeProvider', function($routeProvider) {
  $routeProvider.
	when("/feeds", {templateUrl: "16-routes-feeds.html", controller: "feedsController"}).
	when("/:feed", {templateUrl: "16-routes-feed.html", controller: "feedController"}).
...
app.controller("feedController", ["$scope", "$routeParams", "$window", "appService",
    function($scope, $routeParams, $window, appService) {
        console.log("feedController", $routeParams);
        $scope.feedId = $routeParams.id;
